...
# Status: (substring_to_match, display_string)
_STATUS_MAP = [
    ("בוטלה",                        "בוטלה"),
    ("אחסון",                         "ארכיב (תכנית ישנה שאינה בתוקף)"),
    ("הכרעה בהתנגדויות",              "בתהליך אישור (הוגשו התנגדויות, בהמתנה להכרעה)"),
    ("בהפקדה",                        "בהפקדה (בתהליך אישור — ניתן להגיש התנגדויות)"),
    ("הפקדה",                         "בהפקדה (בתהליך אישור — ניתן להגיש התנגדויות)"),
    ("לפני הפקדה",                    "לפני הפקדה (טרם הוגשה לאישור)"),
    ("מאושר",                         "מאושרת (ניתן להוציא היתר בנייה)"),
    ("בתכנון",                        "בתכנון (עדיין בשלב תכנון)"),
]


def _translate_status(status: str) -> str:
    """Translate technical planning status to plain Hebrew."""
    if not status:
        return ""
    s = status.strip()
